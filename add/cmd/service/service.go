...
import (
	...
	http "github.com/adir-ch/micro-kit/add/pkg/http"
...
var fs = flag.NewFlagSet("add", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "add")
